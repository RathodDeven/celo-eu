    ...
    return (
        <div className="flex flex-col justify-center items-center px-4 py-8 max-w-4xl mx-auto">
            ...
            <div className="text-center">
                ...
                <Link href="/nexus" className="text-blue-600 font-semibold underline hover:text-blue-800">
                    Learn more about the Nexus Program
                </Link>
            </div>

            {!address && (
                <div className="h1 text-red-600 font-semibold mt-10">Please install Metamask and connect.</div>
            )}
