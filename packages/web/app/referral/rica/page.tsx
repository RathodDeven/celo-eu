...
export default function ReferralPageRica() {
  ...
  return (
    <div className="flex flex-col justify-center items-center px-4 py-8 max-w-4xl mx-auto">
      <Image
        src="/rica.png"
        alt="Rica - Marketing & Community @ Celo Europe"
        width={160}
        height={160}
        className="rounded-full mx-auto mb-4 shadow-lg"
      />
      <h1 className="text-4xl font-extrabold mb-2">Rica</h1>
      <p className="text-gray-600 mb-6 text-lg"> Reinassance Builder | Regenerative Speaker</p>
