...
export default function BlogPage() {
  const [posts, _setPosts] = useState<BlogPost[]>([
    // placeholder posts
    {
      ...
      date: "2025-05-04",
      content:
        "This is the beginning of our community blog. Stay tuned for insights, updates, and contributor stories.",
    },
  ])
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <p className="text-center text-gray-600 mb-10">
        A collaborative space for sharing stories, insights, and developments
        across the Celo EU community.
      </p>
